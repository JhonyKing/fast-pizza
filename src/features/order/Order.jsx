  ...
  return (
    <div className="px-4 py-6 space-y-8">
      ...
      <div className="space-y-2 bg-stone-200 py-6 px-5">
        <p className="text-sn font-medium text-stone-600">Price pizza: {formatCurrency(orderPrice)}</p>
        {priority && <p className="text-sn font-medium text-stone-600">Price priority: {formatCurrency(priorityPrice)}</p>}
